...
digraph process {
    ...
    "Use devpowers:finishing-a-development-branch" [shape=box style=filled fillcolor=lightgreen];
    ...
    "Dispatch final code reviewer subagent for entire implementation" -> "Use devpowers:finishing-a-development-branch";
}
```
