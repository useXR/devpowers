...
mkdir -p "$HOME/.config/opencode/devpowers"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/devpowers/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/devpowers/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/devpowers/.opencode/plugin"
cp "$REPO_ROOT/.opencode/plugin/devpowers.js" "$HOME/.config/opencode/devpowers/.opencode/plugin/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugin"
ln -sf "$HOME/.config/opencode/devpowers/.opencode/plugin/devpowers.js" \
       "$HOME/.config/opencode/plugin/devpowers.js"
...
echo "Plugin installed to: $HOME/.config/opencode/devpowers/.opencode/plugin/devpowers.js"
echo "Plugin registered at: $HOME/.config/opencode/plugin/devpowers.js"
