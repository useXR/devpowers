...
# IMPORTANT: Run from devpowers directory so local dev skills are available
...
if grep -q '"name":"Skill".*"skill":"devpowers:subagent-driven-development"' "$SESSION_FILE"; then
